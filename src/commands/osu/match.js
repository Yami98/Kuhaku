...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        const dataOsu = await v2.scores.user.category(5634959, 'recent', {
            include_fails: true,
            mode: 'osu',
            limit: 1
          });
        ...
        const osuJD = utcDate.format('HH:mm:ss DD MMM YYYY');

        // Get the current date and time
        const now = moment();

        // Calculate the difference in years
        const diff = now.diff(utcDate, 'years');
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({
                    text: `Joined osu! at ${osuJD} (${osuYJD})`,
