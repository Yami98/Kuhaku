...
const BeatmapFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_beatmap_free(ptr >>> 0));
/**
...
const BeatmapAttributesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_beatmapattributes_free(ptr >>> 0));
/**
*/
class BeatmapAttributes {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_beatmapattributes_free(ptr);
    }
    /**
    * The approach rate.
    * @returns {number}
    ...
    */
    get odHitWindow() {
        const ret = wasm.__wbg_get_beatmapattributes_odHitWindow(this.__wbg_ptr);
        return ret;
    }
}
...
const BeatmapAttributesBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_beatmapattributesbuilder_free(ptr >>> 0));
/**
*/
class BeatmapAttributesBuilder {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_beatmapattributesbuilder_free(ptr);
    }
    /**
    ...
    */
    build() {
        const ret = wasm.beatmapattributesbuilder_build(this.__wbg_ptr);
...
const DifficultyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_difficulty_free(ptr >>> 0));
/**
...
class Difficulty {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_difficulty_free(ptr);
    }
    /**
...
const DifficultyAttributesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_difficultyattributes_free(ptr >>> 0));
/**
...
class DifficultyAttributes {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_difficultyattributes_free(ptr);
    }
    /**
    ...
    */
    get aim() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_difficultyattributes_aim(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
...
const GradualDifficultyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gradualdifficulty_free(ptr >>> 0));
/**
...
class GradualDifficulty {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gradualdifficulty_free(ptr);
    }
    /**
...
const GradualPerformanceFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gradualperformance_free(ptr >>> 0));
/**
...
class GradualPerformance {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gradualperformance_free(ptr);
    }
    /**
    * @param {Difficulty} difficulty
    * @param {Beatmap} map
...
const PerformanceFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_performance_free(ptr >>> 0));
/**
...
class Performance {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_performance_free(ptr);
    }
    /**
    ...
    */
    set ar(ar) {
        wasm.beatmapattributesbuilder_set_hp(this.__wbg_ptr, !isLikeNone(ar), isLikeNone(ar) ? 0 : ar);
    }
    /**
    * @param {boolean | undefined} [ar_with_mods]
    */
    ...
    */
    set cs(cs) {
        wasm.beatmapattributesbuilder_set_od(this.__wbg_ptr, !isLikeNone(cs), isLikeNone(cs) ? 0 : cs);
    }
    /**
    * @param {boolean | undefined} [cs_with_mods]
    */
...
const PerformanceAttributesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_performanceattributes_free(ptr >>> 0));
/**
...
class PerformanceAttributes {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_performanceattributes_free(ptr);
    }
    /**
...
const StrainsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_strains_free(ptr >>> 0));
/**
...
module.exports.__wbg_getwithrefkey_c697a67e117360f0 = function(arg0, arg1) {
    const ret = getObject(arg0)[getObject(arg1)];
    return addHeapObject(ret);
};
...
module.exports.__wbg_set_5b0ae867e55ab6ae = function(arg0, arg1, arg2) {
