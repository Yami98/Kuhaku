...
export declare const beatmaps: {
    ...
    packs: {
         ...
         */
        details: (pack_tag: string, addons?: import("..").IDefaultParams) => Promise<import("../types/v2/beatmaps_packs_details").BeatmapsPacksDetailsResponse & import("..").IError>;
    };
    /**
    ...
    lookup: <T extends {
        ...
        type: "difficulties";
        ids: number[];
    }>(params: T, addons?: import("..").IDefaultParams) => Promise<T["type"] extends infer T_1 ? T_1 extends T["type"] ? T_1 extends "difficulty" ? import("../types/v2/beatmaps_lookup_difficulty").BeatmapsLookupDifficulty & import("..").IError : T_1 extends "set" ? import("../types/v2/beatmaps_lookup_set").BeatmapsLookupSet & import("..").IError : T_1 extends "attributes" ? import("../types/v2/beatmaps_lookup_attributes").BeatmapsLookupAttributes & import("..").IError : T_1 extends "difficulties" ? import("../types/v2/beatmaps_lookup_difficulties").BeatmapsLookupDifficultiesResponse[] & import("..").IError : import("..").IError : never : never>;
    /**
    ...
    actions: <T_5 extends {
        ...
        beatmapset_id: number;
        add: boolean;
    }>(params: T_5, addons?: import("..").IDefaultParams) => Promise<T_5["type"] extends infer T_6 ? T_6 extends T_5["type"] ? T_6 extends "difficulty" ? any : T_6 extends "difficulties" ? any : import("..").IError : never : never>;
};
/**
 * ##### Description
...
export declare const users: {
    ...
    events: ({ sort, cursor_string, type }?: {
        type?: ("rank" | "achievement" | "beatmapPlaycount" | "beatmapsetApprove" | "beatmapsetDelete" | "beatmapsetRevive" | "beatmapsetUpdate" | "beatmapsetUpload" | "userSupportAgain" | "userSupportFirst" | "userSupportGift" | "usernameChange")[];
        sort?: "id_desc" | "id_asc";
        cursor_string?: string;
